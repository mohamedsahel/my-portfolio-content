{
   "profile": {
      ...
      "social": {
         ...
         "email": "mailto:hi@mohamedsahel.com"
      },
      "resume": "https://githubcontent.com"
   },
   "about": {
      "title": "about me",
   ...
   "projects": {
      ...
      "list":[
         ...
         {
            "name": "Earfun",
            "description": "Full features headphones single page online store application with implementation of cart & checkout process + dark mode support",
         ...
         {
            "name": "Weathi",
            "description": "Beautiful look single page weather application, using Google maps and OpenWeather APIs",
         ...
         {
            "name": "Portfio",
            "description": "Well Designed open source personal portfolio website with interactive animations and dark mode support",
         ...
         {
            "name": "Roomz",
            "description": "Modern, real-time and well-structured chat room back-end API with Implementation of advanced functionalities: authentication - authorization - database management and real-time connections",
            "imageUrl": "https://i.imgur.com/Xcjjrkv.jpg?1",
            "githubUrl": "https://github.com/mohamedsahel/roomz"
         },
         {
            "name": "Qat",
            "description": "Open source CLI tool that helps developers automate workflow tasks using custom CLI commands without reinventing another CLI tool, “Qat stands for Quickly Automate Tasks”",
   ...
   "testimonials": {
      ...
      "list":[
         {
            "author": "Paul",
            "organisation": "bluebox",
            "testimonial": "Awesome working with Mohamed - he is a fast worker, and a good communicator",
            "rating": 5
         },
         {
            "author": "Taco",
            "organisation": "Stainless media",
            "testimonial": "Excellent work, excellent communication, quick response to questions and suggestions and I would definitely recommend Mohamed to anyone!",
            "rating": 5
         },
         {
            "author": "Martyn",
            "organisation": "",
            "testimonial": "Excellent, quick and professional job. Would highly recommend +++++",
            "rating": 5
         }
      ]
   },
